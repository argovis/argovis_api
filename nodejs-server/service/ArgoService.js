 ...
 * returns List
 **/
exports.findBAP = function(id,startDate,endDate,polygon,box,center,radius,metadata,platform,platform_type,positionqc,compression,data,presRange,verticalRange,batchmeta) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = [ {
  "metadata" : [ "metadata", "metadata" ],
