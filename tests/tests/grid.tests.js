  ...
  if (err) {
    ...
    describe("GET /grids/grid_1_1_0.5_0.5", function () {
      it("searches for grids profiles with data=rg09_salinity,except-data-values", async function () {
        const response = await request.get("/grids/grid_1_1_0.5_0.5?id=20040115000000_28.5_-64.5&data=rg09_salinity,except-data-values").set({'x-argokey': 'developer'});
        expect(response.body).to.be.jsonSchema(schema.paths['/grids/{gridName}'].get.responses['200'].content['application/json'].schema);
      });
    });
    ...
    describe("GET /grids/grid_1_1_0.5_0.5", function () {
      it("check correct array packing - temperature", async function () {
        const response = await request.get("/grids/grid_1_1_0.5_0.5?id=20040115000000_29.5_-64.5&data=rg09_temperature").set({'x-argokey': 'developer'});
    ...
    describe("GET /grids/grid_1_1_0.5_0.5", function () {
      it("check correct array packing - salinity", async function () {
        const response = await request.get("/grids/grid_1_1_0.5_0.5?id=20040115000000_29.5_-64.5&data=rg09_salinity").set({'x-argokey': 'developer'});
    ...
    describe("GET /grids/grid_1_1_0.5_0.5", function () {
      it("presRange just intersecting top of range", async function () {
        const response = await request.get("/grids/grid_1_1_0.5_0.5?id=20040115000000_39.5_-64.5&data=rg09_salinity&presRange=0,2.5").set({'x-argokey': 'developer'});
    ...
    describe("GET /grids/grid_1_1_0.5_0.5", function () {
      it("presRange just intersecting bottom of range", async function () {
        const response = await request.get("/grids/grid_1_1_0.5_0.5?id=20040115000000_39.5_-64.5&data=rg09_salinity&presRange=1975,2000").set({'x-argokey': 'developer'});
    ...
    describe("GET /grids/grid_1_1_0.5_0.5", function () {
      it("presRange is inclusive on boundaries", async function () {
        const response = await request.get("/grids/grid_1_1_0.5_0.5?id=20040115000000_39.5_-64.5&data=rg09_salinity&presRange=0,170").set({'x-argokey': 'developer'});
    ...
    describe("GET /grids/grid_1_1_0.5_0.5", function () {
      it("fetch gridded data with pressure bracket", async function () {
        const response = await request.get("/grids/grid_1_1_0.5_0.5?id=20040115000000_20.5_-64.5&presRange=10,100&data=rg09_temperature").set({'x-argokey': 'developer'});
