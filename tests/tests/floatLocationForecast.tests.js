...
$RefParser.dereference(rawspec, (err, schema) => {
  if (err) {
    ...
    // describe("GET /floatLocationForecast", function () {
    //   it("returns one covariance grid result", async function () {
    //     const response = await request.get("/floatLocationForecast?forecastOrigin=-178,-44").set({'x-argokey': 'developer'});   
    //     expect(response.body).to.be.jsonSchema(schema.paths['/floatLocationForecast'].get.responses['200'].content['application/json'].schema);
    ...
    //     const response = await request.get("/floatLocationForecast?forecastOrigin=-178,-44&data=all").set({'x-argokey': 'developer'});   
    //     expect(response.body).to.be.jsonSchema(schema.paths['/floatLocationForecast'].get.responses['200'].content['application/json'].schema);
    //     expect(response.body.length).to.eql(20)
    //   });
    // });
    ...
    //     const response = await request.get("/floatLocationForecast?forecastOrigin=-178,-44&data=all&compression=array").set({'x-argokey': 'developer'});
    ...
    //     const response = await request.get("/floatLocationForecast?id=-178_-44_-178.0_-44.0&data=180").set({'x-argokey': 'developer'});   
    ...
    //     const response = await request.get("/floatLocationForecast?id=-178_-44_-178.0_-44.0&data=180&compression=array").set({'x-argokey': 'developer'});   
    ...
    //     const response = await request.get("/floatLocationForecast?id=-178_-44_-172.0_-44.0").set({'x-argokey': 'developer'});   
    //     expect(response.body).to.be.jsonSchema(schema.paths['/floatLocationForecast'].get.responses['200'].content['application/json'].schema);
    //   });
    // });
    ...
    //     const response = await request.get("/floatLocationForecast?forecastGeolocation=-176,-44").set({'x-argokey': 'developer'});   
    //     expect(response.body).to.be.jsonSchema(schema.paths['/floatLocationForecast'].get.responses['200'].content['application/json'].schema);
    ...
    //     const response = await request.get("/floatLocationForecast?forecastGeolocation=-176,-44&data=1800").set({'x-argokey': 'developer'});   
    //     expect(response.body).to.be.jsonSchema(schema.paths['/floatLocationForecast'].get.responses['200'].content['application/json'].schema);
    //   });
    // });
    ...
    //     const response = await request.get("/floatLocationForecast/meta?id=covariance").set({'x-argokey': 'developer'});   
