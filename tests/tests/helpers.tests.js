...
describe("cost functions", function () {
  it("cost of metadata request should be scaled my metaDiscount", async function () {
    expect(helpers.cost('/grids/meta?id=localGPspace_ohc15to300', c, cellprice, metaDiscount, maxbulk, maxbulk_timeseries, ratelimiter)).to.eql(c/metaDiscount);
  });
}); 
